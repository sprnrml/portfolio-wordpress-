    ...
    <ul class="skill_container">
      ...
      <li>
        <ul>
          ...
          <li><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star black"></i><i class="fas fa-star black"></i><i class="fas fa-star black"></i></li>
      ...
      <li>
        <ul>
          ...
          <li><i class="fas fa-star"></i><i class="fas fa-star"><i class="fas fa-star black"></i><i class="fas fa-star black"></i><i class="fas fa-star black"></i></i></li>
